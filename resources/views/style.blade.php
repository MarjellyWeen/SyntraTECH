  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="/courses"><span>Syntra<span style="color:#3498db">TECH</span></a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="{{ Request::path() === 'courses' ? 'active' : '' }}"><a href="/courses">Home</a></li>
    ...
    <div class="container">
      <div class="row d-flex align-items-center">
        <div class="col-lg-6 text-lg-left text-center">
          <div class="copyright">
            &copy; Copyright <strong>SyntraTech</strong>. All Rights Reserved
          </div>
          <div class="credits">
            ...
            Designed by <a href="#">FullStackers (i.o. Syntra-Limburg)</a>
          </div>
        </div>
        <div class="col-lg-6">
